...
TEST_IMAGE_CAPABILITY = os.getenv("TEST_IMAGE_CAPABILITY", "false").lower() == "true"
...
def main():
    ...
    raise SystemExit(0 if tool_ok and no_tool_ok and reasoning_ok and content_ok and image_ok else 1)
