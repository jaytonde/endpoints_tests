...
VLLM_MODEL="${VLLM_MODEL:-gemma-4-31B-it}"
SERVER_URL="${VLLM_SERVER_URL:-http://localhost:30000}"
TOKENIZER="${VLLM_TOKENIZER:-/home/ubuntu/models/gemma-4-31B-it}"
...
CONCURRENCY_LEVELS="${CONCURRENCY_LEVELS:-128 256 512}"
RESULT_DIR="${RESULT_DIR:-./vllm-benchmark-results/gemma-4-31B-it}"
